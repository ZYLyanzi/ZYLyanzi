	...
	<section>
		...
		<div class="page-part">
            ...
            <div class="explain">
	            ...
	            <p>（1）充值发布积分，1积分=0.01元  100积分=1元；</p>
	            <p>（2）发布积分只可用来发布任务使用，不可提现，不予退还  首充必须满10元以上；</p>
	            <p>（3）充值方式:目前只支持唯一官方支付宝充值：mx@maox.cc 猫仙（深圳）网络科技有限公司</p>
	            <p> （4）微信支付先加：ttaibaigou（官方指定客服）</p>
	            <p>（充值时备注您的账户ID。只备注ID多余的不需要写）。</p>
	            <p> 注意：恶意发布积分者永久封账号</p>
            </div>
		</div>
